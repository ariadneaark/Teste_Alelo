...
public class StartScript {
	...
	public static WebDriver getDriver() throws MalformedURLException {
		...
		// --------------------------------------------------------------
		// ariadne.mendes: Modal para o usuário escolher entre a opção de 'Importar um
		// arquivo' ou 'Definir os valores por parâmetro'
		int resposta;

		JFrame frame = new JFrame("Importar um arquivo");
		resposta = JOptionPane.showConfirmDialog(frame, "Gostaria de importar um arquivo?", "Importar um arquivo",
